...
var firebaseConfig={apiKey:"AIzaSyAaVVlIVaomAuhJxt75hkLrxid6kt1dXVM",authDomain:"amit-6b7b6.firebaseapp.com",projectId:"amit-6b7b6",storageBucket:"amit-6b7b6.appspot.com",messagingSenderId:"207665282730",appId:"1:207665282730:web:e46ea2120b5e23f5a05ad3",measurementId:"G-RK412JV7N4"};firebase.initializeApp(firebaseConfig),firebase.analytics();var storage=firebase.storage(),storageRef=storage.ref();const table=document.getElementById("table"),name=sessionStorage.getItem("NAME"),type=sessionStorage.getItem("TYPE");storageRef.child("Classes").listAll().then(function(e){e.prefixes.forEach(function(e){}),e.items.forEach(function(e){if("Teachers.txt"!==e.name){let a=document.createTextNode(e.name.split(".")[0]);var t=table.insertRow();t.insertCell().appendChild(a),t.onclick=function(){sessionStorage.setItem("CLASS",e.name.split(".")[0]),location.href="class.html"}}})}).catch(function(e){console.log(e)}),window.addEventListener("storage",function(e){e.storageArea===sessionStorage&&(alert("האתר זיהה ניסיון חשוד לשינוי פרטים!"),sessionStorage.clear(),location.href="index.html")});

...
var firebaseConfig={apiKey:"AIzaSyAaVVlIVaomAuhJxt75hkLrxid6kt1dXVM",authDomain:"amit-6b7b6.firebaseapp.com",projectId:"amit-6b7b6",storageBucket:"amit-6b7b6.appspot.com",messagingSenderId:"207665282730",appId:"1:207665282730:web:e46ea2120b5e23f5a05ad3",measurementId:"G-RK412JV7N4"};firebase.initializeApp(firebaseConfig),firebase.analytics();var storage=firebase.storage(),storageRef=storage.ref(),db=firebase.firestore();const title=document.getElementById("title"),div=document.getElementById("div"),name=sessionStorage.getItem("NAME"),type=sessionStorage.getItem("TYPE"),meetingName=sessionStorage.getItem("MEETING"),UDF=sessionStorage.getItem("U/D/F");var email="";db.collection("users").where("name","==",meetingName.split(".")[0].split("&")[0]).get().then(function(e){e.forEach(function(e){email=e.id})}).catch(function(e){console.log("Error getting documents: ",e)}),title.innerHTML=meetingName.split(".")[0].replace("&"," - "),"U"===UDF&&storageRef.child("Meetings/Upcoming/"+meetingName).getDownloadURL().then(function(e){var t=new XMLHttpRequest;t.responseType="blob",t.onload=function(e){t.response.text().then(e=>{if("student"===type||"admin"===type){let t=document.createElement("h3");t.innerHTML="הפגישה עוד לא נעשתה",div.appendChild(document.createTextNode(e.split("&&")[2]+" - "+e.split("&&")[3])),div.appendChild(document.createElement("br")),div.appendChild(t)}if("teacher"===type){div.appendChild(document.createTextNode(e.split("&&")[2]+" - "+e.split("&&")[3])),div.appendChild(document.createElement("br"));let d=document.createElement("h3");d.innerHTML="אנא שלח כשהפגישה בוצעה וצרף משוב:",div.appendChild(d);var t=document.createElement("textarea");t.cols=40,t.rows=10,div.appendChild(t),div.appendChild(document.createElement("br")),div.appendChild(document.createElement("br"));var n=document.createElement("button");n.innerHTML="שליחה",div.appendChild(n),n.onclick=function(){var i=document.createElement("h4");i.innerHTML="מזין את המשוב... נא לא לצאת מהמסך!",document.body.appendChild(i);var a=e.split("&&"),o=a[0]+"&&"+a[1]+"&&"+a[2]+"&&"+a[3]+"&&"+a[4]+"&&"+t.value+"&&",l=new Blob([o],{type:"text/plain;charset=utf-8"});storageRef.child("Meetings/Done/"+meetingName).put(l).then(function(){storageRef.child("Meetings/Upcoming/"+meetingName).delete().then(function(){storageRef.child("Emails/"+email+".txt").put(l).then(function(){d.innerHTML="המשוב הוזן בהצלחה!",t.style.display="none",n.style.display="none",i.style.display="none"})})})}}})},t.open("GET",e),t.send()}).catch(function(e){console.log(e)}),"D"===UDF&&storageRef.child("Meetings/Done/"+meetingName).getDownloadURL().then(function(e){var t=new XMLHttpRequest;t.responseType="blob",t.onload=function(e){t.response.text().then(e=>{if("student"===type){div.appendChild(document.createTextNode(e.split("&&")[2]+" - "+e.split("&&")[3])),div.appendChild(document.createElement("br"));let d=document.createElement("h3");d.innerHTML="אנא מלא משוב על הפגישה:";let i=document.createElement("p");i.innerHTML="במידה ואתה לא מעוניין נא לשלוח ריק.",div.appendChild(d),div.appendChild(i);var t=document.createElement("textarea");t.cols=40,t.rows=10,div.appendChild(t),div.appendChild(document.createElement("br")),div.appendChild(document.createElement("br"));var n=document.createElement("button");n.innerHTML="שליחה",div.appendChild(n),n.onclick=function(){var a=document.createElement("h4");a.innerHTML="מזין את המשוב... נא לא לצאת מהמסך!",document.body.appendChild(a);var o=e.split("&&"),l=o[0]+"&&"+o[1]+"&&"+o[2]+"&&"+o[3]+"&&"+t.value+"&&"+o[5]+"&&",p=new Blob([l],{type:"text/plain;charset=utf-8"});storageRef.child("Meetings/Finished/"+meetingName).put(p).then(function(){storageRef.child("Meetings/Done/"+meetingName).delete().then(function(){d.innerHTML="המשוב הוזן בהצלחה!",i.style.display="none",t.style.display="none",n.style.display="none",a.style.display="none"})})}}if("teacher"===type){let t=document.createElement("h3");t.innerHTML="הפגישה נעשתה",div.appendChild(document.createTextNode(e.split("&&")[2]+" - "+e.split("&&")[3])),div.appendChild(document.createElement("br")),div.appendChild(t)}if("admin"===type){let t=document.createElement("h3");t.innerHTML="משוב תלמיד",t.style.margin=0;let n=document.createElement("h3");n.innerHTML="משוב מורה",n.style.margin=0,div.appendChild(document.createTextNode(e.split("&&")[2]+" - "+e.split("&&")[3])),div.appendChild(document.createElement("br")),div.appendChild(document.createElement("br")),div.appendChild(t),div.appendChild(document.createTextNode("עוד לא הוזן משוב תלמיד.")),div.appendChild(document.createElement("br")),div.appendChild(document.createElement("br")),div.appendChild(n),div.appendChild(document.createTextNode(e.split("&&")[5]))}})},t.open("GET",e),t.send()}).catch(function(e){console.log(e)}),"F"===UDF&&storageRef.child("Meetings/Finished/"+meetingName).getDownloadURL().then(function(e){var t=new XMLHttpRequest;t.responseType="blob",t.onload=function(e){t.response.text().then(e=>{if("student"===type||"teacher"===type){let t=document.createElement("h3");t.innerHTML="הפגישה נעשתה",div.appendChild(document.createTextNode(e.split("&&")[2]+" - "+e.split("&&")[3])),div.appendChild(document.createElement("br")),div.appendChild(t)}if("admin"===type){let t=document.createElement("h3");t.innerHTML="משוב תלמיד",t.style.margin=0;let n=document.createElement("h3");n.innerHTML="משוב מורה",n.style.margin=0,div.appendChild(document.createTextNode(e.split("&&")[2]+" - "+e.split("&&")[3])),div.appendChild(document.createElement("br")),div.appendChild(document.createElement("br")),div.appendChild(t),div.appendChild(document.createTextNode(e.split("&&")[4])),div.appendChild(document.createElement("br")),div.appendChild(document.createElement("br")),div.appendChild(n),div.appendChild(document.createTextNode(e.split("&&")[5]))}})},t.open("GET",e),t.send()}).catch(function(e){console.log(e)}),window.addEventListener("storage",function(e){e.storageArea===sessionStorage&&(alert("האתר זיהה ניסיון חשוד לשינוי פרטים!"),sessionStorage.clear(),location.href="index.html")});
